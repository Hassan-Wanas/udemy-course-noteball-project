  ...
  <nav class="navbar is-success" role="navigation" aria-label="main navigation">
    ...
    <div class="container is-max-desktop">
      <div class="navbar-brand">
        ...
        <a @click="showMobileNav = !showMobileNav" role="button" class="navbar-burger"
      ...
      <div id="navbarBasicExample" class="navbar-menu" :class="{ 'is-active': showMobileNav }" ref="navbarMenuRef">
        <div class="navbar-start">
          <button v-if="storeAuth.user.id" @click="logout" class="button is-small is-info mt-3 ml-3">Log out : {{
        ...
        <div class="navbar-end">
          ...
          <RouterLink @click="showMobileNav = false" to="/stats" class="navbar-item" activeClass="is-active">
            Stats
          </RouterLink>
        </div>
      </div>
